...
const TEAM_MEMBERS = [
  // ===== Managers =====
  {
    ...
    group: "Managers",
    label: "Lead Manager",
    avatarUrl: "src/assets/TeamMembers/Saurabh.jpg",
    skills: "Full Stack",
  ...
  },
  {
    ...
    group: "Managers",
    label: "Lead Manager",
    avatarUrl: "src/assets/TeamMembers/Shambhavi.jpg",
  ...
  },
  {
    ...
    group: "Managers",
    label: "Core Manager",
    avatarUrl: "src/assets/TeamMembers/Suparn.jpg",
    skills: "AI/ML · DSA",
  ...
  },
  {
    ...
    group: "Managers",
    label: "Core Manager",
    avatarUrl: "src/assets/TeamMembers/Ankur.jpg",
    skills:
  ...
  },
  {
    ...
    group: "Managers",
    label: "Lead Manager",
    avatarUrl: "src/assets/TeamMembers/Shishir.jpg",
    skills:
      "React Native · Node.js · Git · DBMS · Operating Systems · Computer Networks",
  ...
  },
  {
    ...
    group: "Managers",
    label: "Lead Manager",
    avatarUrl: "src/assets/TeamMembers/Murali.jpeg",
    skills:
      "React Native · Node.js · Git · DBMS · Operating Systems · Computer Networks",
    linkedin: "https://www.linkedin.com/in/shishir-govinda-m/",
  },
  ...
  // ===== Technical =====
  {
    ...
    avatarUrl: "src/assets/TeamMembers/Supreeth.jpg",
  ...
  },
  {
    ...
    group: "Technical",
    label: "Core Technical",
    avatarUrl: "src/assets/TeamMembers/Anurag.jpg",
  ...
  },
  {
    ...
    group: "Technical",
    label: "Core Technical",
    avatarUrl: "src/assets/TeamMembers/Sanya.jpg",
  ...
  },
  {
    ...
    avatarUrl: "src/assets/TeamMembers/Rishabh.jpg",
  ...
  // ===== Design =====
  {
    ...
    group: "Design",
    label: "Core Design",
    avatarUrl: "src/assets/TeamMembers/Nidhi.jpeg",
    skills:
  ...
  },
  {
    ...
    group: "Media + Social",
    label: "Lead Socials",
    avatarUrl: "src/assets/TeamMembers/Sufyan.jpg",
    skills:
